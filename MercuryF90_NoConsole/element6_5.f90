!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
!
!      ELEMENT6.FOR    (ErikSoft   21 September 2009)
!
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
!
...
! What type elements does the user want?
  ...
  45  read (10,'(a250)') string
      ...
      if (c2.eq.'ce'.or.c2.eq.'CE'.or.c2.eq.'Ce') then
        ...
        centre = 2
!      else if (c2.eq.'cb'.or.c2.eq.'CB'.or.c2.eq.'CL'.or.c2.eq.'cl'
!     %  .or.c2.eq.'Cl') then
!        centre = 3
      else
...
!
! Decompress the time and number of objects
          time = mio_c2fl (cc(1:8))
          old_nbig = nbig
          old_nsml = nsml
          nbig = int(.5d0 + mio_c2re(cc(9:16),  0.d0, 11239424.d0, 3))
          nsml = int(.5d0 + mio_c2re(cc(12:19), 0.d0, 11239424.d0, 3))
! If some lines are missing...
...
!
! For each object, decompress its orbital variables
...
! Move on to the next time slice
        goto 100
!
! If input file is corrupted, go to next uncorrupted special output
 666    continue
...
!
        ...
        if (timestyle.eq.0.or.timestyle.eq.2) then
          ...
          write (*,'(a,i12,1x,i2,1x,f7.5,a)') '       Time: ',year,month
        else
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
!
!      MCO_H2CB.FOR    (ErikSoft   29 August 2001)
!
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
!
! Author: John E. Chambers
...
! coordinates (for use in element6.for only).
!
!------------------------------------------------------------------------------
!
