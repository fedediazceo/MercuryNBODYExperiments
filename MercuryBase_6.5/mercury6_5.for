c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c
c      MERCURY6_1.FOR    (ErikSoft   3 March 2005)
c
c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c
...
c
c If outside other massive bodies, is an artifact due to barycentric motion
...
c et al. (1973) Astron. J. 78, 211-225, with magnitude determined by the
...
c
c If using barycentric orbit for small body, it must have the same epoch
c as the big bodies
...
c
c If using barycentric elements for small bodies convert to heliocentric elements
...
c
 ...
 140    close (11)
c
c Calculate barycentric position and velocity of central body
        if (j.eq.1) then
          xcen(1) = xcen(1) / mbig
          xcen(2) = xcen(2) / mbig
          xcen(3) = xcen(3) / mbig
